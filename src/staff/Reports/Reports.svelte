<script>
  import { ArrowRight, Clock, Printer, Gavel, MessageSquareWarning } from "lucide-svelte";
...
<div class="bg-white h-fit sm:mx-4 mx-2 mb-2 my-8 rounded">
  ...
  <div class="flex justify-between items-center mx-4 sm:mx-12 gap-2 print:hidden">
    <div class="flex items-center gap-2">
      ...
      <select class="select select-sm py-0 select-bordered border-gray-200 h-fit" name="time" bind:value={timeRange} on:change={() => onTimeChange()}>
